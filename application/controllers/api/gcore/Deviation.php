...
class Deviation extends ApiController
{
	...
	public function index()
	{
		if($get = $this->input->get()){
			...
			$this->pawn->db2
					->select("office_name,product_name,customers.name as customer,sge,contract_date,due_date,auction_date,estimated_value,loan_amount,admin_fee,monthly_fee,interest_rate,insurance_item_name,transaction_deviations.deviation_type,transaction_deviations.office_type,
