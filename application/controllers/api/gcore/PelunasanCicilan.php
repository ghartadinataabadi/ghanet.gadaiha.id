...
class PelunasanCicilan extends ApiController
{
	...
	public function index()
	{
		if($get = $this->input->get()){
			...
			$this->pawn->db2
					->select("office_name,product_name,customers.name as customer,sge,contract_date,due_date,auction_date,repayment_date,estimated_value,loan_amount,admin_fee, pawn_transactions.monthly_fee, installment_details.tenor,interest_rate,insurance_item_name,created_by,approved_by,
