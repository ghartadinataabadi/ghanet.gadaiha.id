	...
	{		
		...
		$objPHPExcel->getProperties()->setCreator("O'nur")
				...
				// 	$objPHPExcel->getActiveSheet()->setCellValue('P4', 'Gramasi');
					...
					$objPHPExcel->getActiveSheet()->setCellValue('R4', 'Tanggal Pelunasan');
					...
					if($get = $this->input->post()){
						...
						$this->pawn->db2
								...
								// 	$objPHPExcel->getActiveSheet()->getStyle('P'.$no)->getNumberFormat()->setFormatCode('#,##0');	
									...
									$objPHPExcel->getActiveSheet()->setCellValue('R'.$no, $row->repayment_date);	//Tanggal Jatuh Tempo									
									...
									$objPHPExcel->getActiveSheet()->setCellValue('V'.$no, $row->description_items);				//Deskripsi BJ		 
									$no++;
								}
