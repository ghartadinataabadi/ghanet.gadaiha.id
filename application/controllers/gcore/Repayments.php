...
class Repayments extends Authenticated
{
	/**
	 * @var string
	 */
	...
	{
		$this->load->view('report/gcore/repayment/index');
    } 	
	...
	{		
		...
		$objPHPExcel->getProperties()->setCreator("O'nur")
					...
					if($get = $this->input->post()){
						...
						$this->pawn->db2
									->select("pawn_transactions.office_name,pawn_transactions.product_name,customers.name as customer,pawn_transactions.sge,pawn_transactions.contract_date,pawn_transactions.due_date,pawn_transactions.auction_date,pawn_transactions.repayment_date,pawn_transactions.estimated_value,pawn_transactions.maximum_loan_percentage,pawn_transactions.transaction_type,pawn_transactions.loan_amount,pawn_transactions.admin_fee, pawn_transactions.monthly_fee,transaction_payment_details.rental_amount,transaction_payment_details.fine_amount,transaction_payment_details.payment_amount,pawn_transactions.interest_rate,pawn_transactions.insurance_item_name,pawn_transactions.created_by,pawn_transactions.approved_by,
										sum(transaction_insurance_items.net_weight) as gramasi,
									")
