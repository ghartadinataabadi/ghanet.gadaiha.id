...
<div class="kt-subheader   kt-grid__item" id="kt_subheader">
    <div class="kt-container ">
        <div class="kt-subheader__main">
            ...
            <span class="kt-subheader__desc">Sales Agent</span>
        </div>
				...
				<div class="col-md-12" >
					<div class="form-group row">
                        ...
                        <select class="form-control" name="produk" id="produk">
                            ...
                            <option value="Gadai Reguler Sales Agent">Gadai Reguler Sales Agent</option>
                            <option value="Gadai Opsi Sales Agent">Gadai Opsi Sales Agent</option>
                            <option value="Gadai Sales Agent Khusu">Gadai Sales Agent Khusu</option>
                        </select>
            ...
            <a href= '#' class="btn btn-danger btn-icon" name="btnexport_csv" id="btnexport_csv"><i class="fa fa-file-excel"></i></a>
                ...
                <div class="kt-section__content table-responsive">
                  ...
                  <th class="text-center">Referral Code</th>
									<th >Nama Agent</th>
									<th class="text-center">Type Agent</th>
									<th class="text-center">SGE</th>
									<th class='text-right'>Taksiran</th>
									<th class="text-right">UP</th>
									<th class='text-right'>Admin</th>
									<th class='text-right'>Sewa/bulan</th>
									<th class='text-right'>Rate</th>
									<th class="text-center">LTV</th>
									<th class="text-center">Sumber Fee</th>
									<th class="text-center">Persentase Fee</th>
									<th class="text-center">Fee GHA/bulan</th>
									<th class="text-center">Fee Agent/bulan</th>
									<th class="text-center">Total_Fee GHA</th>
									<th class="text-center">Total_Fee Agent</th>
...
$this->load->view('agent/script.php');
