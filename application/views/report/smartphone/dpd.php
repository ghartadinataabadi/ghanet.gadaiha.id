        ...
        <div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
            <div class="kt-portlet kt-portlet--mobile">
                ...
                <div class="kt-portlet__body kt-portlet__body--fit">
                    ...
                    <form id="form_bukukas" class="form-horizontal" method="post"
                        action="<?php echo base_url("report/smartphone/export_dpd"); ?>">
                            ...
                            <div class="col-md-12">
                                <div class="form-group row">
                                    ...
                                    <input type="hidden" name="area"
                                        value="<?php echo $this->session->userdata('user')->id_area;?>">
                                    <div class="col-lg-2">
                                    ...
                                    <input type="hidden" name="cabang"
                                        value="<?php echo $this->session->userdata('user')->id_cabang;?>">
                                    <div class="col-lg-2">
                                        <label class="col-form-label">Unit</label>
                                        <select class="form-control select2" name="id_unit" id="unit">
                                            <option value="0">All</option>
							...
							<?php endforeach;?>
                                    ...
                                    <div class="col-lg-2">
                                        ...
                                        <input type="date" class="form-control" name="date-start"
                                            value="<?php echo date('Y-m-d', strtotime(date($date).' -30 days'));?>">
                                    </div>
                                    <div class="col-lg-2">
                                    ...
                                    <input type="hidden" class="form-control" name="date-last"
                                        value="<?php echo date('Y-m-d', strtotime($date));?>">
                                        <input type="hidden" class="form-control" name="date-now"
                                        value="<?php echo date('Y-m-d');?>">
                                ...
                                <option value="-10">5.-10 DPD</option>
                                    ...
                                    <div class="col-lg-1">
                                        ...
                                        <div class="position-relative">
                                            <button type="button" class="btn btn-brand btn-icon" name="btncari"
                                                id="btncari"><i class="fa fa-search"></i></button>
                                            <button type="submit" class="btn btn-danger btn-icon" name="btnexport_csv"
                                                id="btnexport_csv"><i class="fa fa-file-excel"></i></button>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <table class="table">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class='text-center'>Sewa Modal(1 Bulan)</th>
...
$this->load->view('report/smartphone/js_dpd.php');
?>