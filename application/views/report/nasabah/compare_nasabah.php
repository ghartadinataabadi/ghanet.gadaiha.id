...
<div class="kt-subheader   kt-grid__item" id="kt_subheader">
    <div class="kt-container ">
        <div class="kt-subheader__main">            
            ...
            <span class="kt-subheader__desc">Nasabah Yogadai</span>            
        </div>
...
<!-- end:: Content Head -->
 ...
 <div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
        ...
        <div class="kt-portlet__body kt-portlet__body--fit">
            ...
            <form id="form_bukukas" class="form-horizontal" method="get" action="<?php echo base_url("report/nasabah/transaksi_excel"); ?>">
            ...
            <div class="col-md-12" > 
                ...
                <?php endif ;?>
                    <div class="col-lg-2">
                        ...
                        <button type="submit" class="btn btn-danger btn-icon" name="btnexport_nasabah" id="btnexport_nasabah"><i class="fa fa-file-excel"></i></button>
                    </div>
				</div>	               
...
<?php 
$this->load->view('report/nasabah/_add.php');
$this->load->view('temp/Footer.php');
$this->load->view('report/nasabah/_script_compare_nasabah.php');
?>
