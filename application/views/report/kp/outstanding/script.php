            ...
            success: function(response, status) {
                ...
                if (response.status == true) {
                    ...
                    $.each(response.data, function(index, data) {
                        ...
                        template += "<td class='text-center'>" + tenor + "</td>";
                        ...
                        if(data.product_name ==  'Gadai Elektronik'){
                            merk = data.merk;
                        }else{
                            merk = '-';
                        }
                        ...
                        template += "<td class='text-center'>" + merk + "</td>";
                        template += "<td class='text-left'>" + data.phone_number + "</td>";
                        template += "<td class='text-left'>" + data.address + "</td>";
                        template += "<td class='text-center'>" + data.mother_name + "</td>";
                        template += "<td class='text-center'>" + data.identity_number + "</td>";
