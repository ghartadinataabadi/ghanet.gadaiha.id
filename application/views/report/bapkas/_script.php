				...
				if(response.status == true){
					...
					$.each(response.data, function (index, data) {
                        ...
                        if(data.bapkas!=null){
                            ...
                            template += "<td class='text-right'>"+convertToRupiah(parseInt(data.bapkas.saldoawalpetty))+"</td>";
                            template += "<td class='text-right'>"+convertToRupiah(parseInt(data.bapkas.penerimaanpetty))+"</td>";
                            template += "<td class='text-right'>"+convertToRupiah(parseInt(data.bapkas.pengeluaranpetty))+"</td>";
                            template += "<td class='text-right'>"+convertToRupiah(parseInt(data.bapkas.saldoakhirpetty))+"</td>";
                            template += "<td class='text-right'>"+convertToRupiah(parseInt(data.bapkas.totalsaldoakhir))+"</td>";
                            ...
                            // template += "<td class='text-right'>"+convertToRupiah(parseInt(data.bapkas.noa_handphone))+"</td>";
                            // template += "<td class='text-right'>"+convertToRupiah(parseInt(data.bapkas.os_handphone))+"</td>";
                        ...
                        if(data.bapkas!=null){
                            ...
                            amountInMoker += parseInt(data.bapkas.amount_inmoker);
                            amountOut += parseInt(data.bapkas.amount_out);
                            amountOutNon += parseInt(data.bapkas.amount_outnon);
                    ...
                    $('.kt-section__content table').find('tfoot').find('.penerimaanMoker').text(convertToRupiah(parseInt(amountInMoker)));
                    $('.kt-section__content table').find('tfoot').find('.pengeluaran').text(convertToRupiah(parseInt(amountOut)));
                    $('.kt-section__content table').find('tfoot').find('.pengeluaranNon').text(convertToRupiah(parseInt(amountOutNon)));
