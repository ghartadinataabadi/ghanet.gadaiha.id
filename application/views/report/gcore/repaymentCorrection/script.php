...
function initCariForm() {
    ...
    $('#btncari').on('click', function() {
        ...
        $.ajax({
            type: 'GET',
            url: "<?php echo base_url("api/gcore/repaymentCorrection"); ?>",
            dataType: "json",
            data: {
                area_id: area_id,
                date: date,
                ...
                if (response.status == true) {
                    ...
                    $.each(response.data, function(index, data) {
                      ...
                      console.log(data.id);
                        ...
                        template += "<td class='text-left'>" + moment(data.contract_date).format('DD-MM-YYYY') + "</td>";
                        template += "<td class='text-left'>" + moment(data.due_date).format('DD-MM-YYYY') + "</td>";
                        template += "<td class='text-left'>" + moment(data.auction_date).format('DD-MM-YYYY') + "</td>";
                        template += "<td class='text-left'>" + moment(data.correction_at).format('DD-MM-YYYY') + "</td>";
                        ...
                        template += "<td class='text-left'>" + data.interest_rate + "</td>";
                        template += "<td class='text-left'>" + data.ltv + "</td>";
                        
                        template += "<td class='text-left'>" + data.insurance_item_name + "</td>";
                        template += "<td class='text-left'>" + data.created_by + "</td>";
                        template += "<td class='text-left'>" + data.approved_by + "</td>";                        
                    ...
                    template += "<td class='text-right'>" + convertToRupiah(totalTaksiran) + "</td>";
                    template += "<td class='text-right'>" + convertToRupiah(totalUp) + "</td>";
                    template += "<td class='text-right'>" + convertToRupiah(totalAdmin) + "</td>";
                    template += "<td class='text-right'>" + convertToRupiah(totalSewa) + "</td>";
