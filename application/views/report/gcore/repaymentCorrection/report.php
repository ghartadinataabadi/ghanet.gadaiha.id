<h3>Monitoring Saldo Kas Siscab Unit <?php echo date('d-m-Y');  ?></h3>
<?php $totAllsaldo=0; $totAllmoker=0; $totAllselisih=0; $totAllminus=0; $totAllplus=0;  $no = 0;  
foreach($pagukas as $area => $datas):?>
<table class="table" border="1">
            ...
            ?>
            <?php  $selisih= $data->bapkas - $data->pagu;?>
                <tr <?php echo $selisih > 0 ?  'bgcolor="#C3F1CB"' : 'bgcolor="#F1DFC3"';?>>
                    ...
                    <td align="right"   width="80"><?php echo number_format($data->bapkas,0);?></td>
                    <td align="right"   width="80"><?php echo number_format($data->pagu,0);?></td>
