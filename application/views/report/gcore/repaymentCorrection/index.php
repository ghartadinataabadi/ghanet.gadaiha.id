 ...
 <div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
        <div class="kt-portlet kt-portlet--mobile">
			...
			<div class="kt-portlet__body kt-portlet__body--fit">
				...
				<form id="form_bukukas" class="form-horizontal" method="post" action="<?php echo base_url("gcore/repaymentCorrection/export"); ?>">
...
$this->load->view('report/gcore/repaymentCorrection/script.php');
// $this->load->view('report/gcore/outstanding/script.php');
