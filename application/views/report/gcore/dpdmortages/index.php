...
<div class="kt-subheader   kt-grid__item" id="kt_subheader">
    <div class="kt-container ">
        <div class="kt-subheader__main">
            ...
            <span class="kt-subheader__desc">DPD Cicilan Emas</span>
        </div>
 ...
 <div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
        <div class="kt-portlet kt-portlet--mobile">
			...
			<div class="kt-portlet__body kt-portlet__body--fit">
				...
				<form id="form_bukukas" class="form-horizontal" method="post" action="<?php echo base_url("gcore/dpd/export"); ?>">
						...
						<table class="table">
						  	<thead class="thead-light">
						    	<tr>
									...
									<th class='text-center'>Rate/Bulan</th>
...
$this->load->view('report/gcore/dpdmortages/script.php');
?>
