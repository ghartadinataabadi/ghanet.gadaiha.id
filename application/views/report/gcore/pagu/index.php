...
<div class="kt-subheader   kt-grid__item" id="kt_subheader">
    <div class="kt-container ">
        <div class="kt-subheader__main">
            ...
            <span class="kt-subheader__desc">Pagu Kas</span>
        </div>
...
<!-- end:: Content Head -->
 ...
 <div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
        ...
        <div class="kt-portlet__body kt-portlet__body--fit">
            ...
            <form id="form_bukukas" class="form-horizontal" method="post" action="<?php echo base_url("gcore/pagukas/export"); ?>">
            ...
            <div class="col-md-12" >
                <div class="form-group row">
                    ...
                    <div class="col-lg-2">
                        ...
                        <button type="submit" class="btn btn-warning btn-icon" name="btnexport_csv" id="btnexport_csv"><i class="fa fa-file-excel"></i></button>
                        <button type="button" class="btn btn-success btn-icon" name="btnexport_pdf" id="btnexport_pdf" onclick="exportpdf()"><i class="fa fa-file-pdf"></i></button>
                        <!-- <a href="<?php echo base_url('gcore/pagukas/reportpdf?date='.$this->input->post('date-start')); ?>" class="btn btn-success btn-icon" ><i class="fa fa-file-pdf"></i></a> -->
                        </div>
                    </div>                  
				</div>
						...
						<table class="table">
						  	<thead class="thead-light">
						    	<tr>
									...
									<th class='text-right'>Pagu Kas</th>
									<th class='text-right'>Lebih(Kurang)</th>
                            ...
                            <tfoot>
                                <tr bgcolor="#EAEDED">
                                    ...
                                    <th class="kas text-right"></th>
                                    <th class="moker text-right"></th>
                                    <th class="selisih text-right"></th>
                                    <th class="description text-right"></th>
                                </tr>
                            </tfoot>
						</table>
				</div>
...
$this->load->view('report/gcore/pagu/_script.php');
?>
