...
<div class="kt-subheader   kt-grid__item" id="kt_subheader">
    <div class="kt-container ">
        <div class="kt-subheader__main">
            ...
            <span class="kt-subheader__desc">Rekap Transaksi</span>
        </div>
                ...
                <div class="form-group row">
					...
					<?php endif ;?>
                        <div class="col-lg-2">
							...
							<select class="form-control select2" name="type_transaction" id="type_transaction">
								<!-- <option value="0">All</option> -->
                        ...
                        <!-- <div class="col-lg-1">
                            ...
                            <input type="text" class="form-control" name="sge">
						</div> -->

					<div class="col-lg-2">
						<label class="col-form-label">Tanggal</label>
						<input type="date" class="form-control" name="dateStart" value="<?php echo date('Y-m-d');?>">
					</div>
					<div class="col-lg-2">
						<label class="col-form-label">Sampai</label>
						<input type="date" class="form-control" name="dateEnd" value="<?php echo date('Y-m-d');?>">
					</div>                    
                    <div class="col-lg-2">
						...
						<table class="table">
						  	<thead class="thead-light">
						    	<tr>
									...
									<th class='text-center'>Date Repayment</th>
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <th class="totup text-right">0</th>
...
$this->load->view('report/transactions/transaction/_script.php');
?>
