...
<div class="kt-subheader   kt-grid__item" id="kt_subheader">
    <div class="kt-container ">
        <div class="kt-subheader__main">
            ...
            <span class="kt-subheader__desc">Bobot KPI</span>
        </div>
...
// $this->load->view('datamaster/kpi/bobot/_add.php');
// $this->load->view('datamaster/kpi/bobot/_edit.php');
$this->load->view('datamaster/kpi/bobot/_view.php');
$this->load->view('datamaster/kpi/bobot/_viewpdf.php');
$this->load->view('datamaster/kpi/bobot/_script.php');
?>
