		...
		<div class="kt-header-menu-wrapper" id="kt_header_menu_wrapper">
			<div id="kt_header_menu" class="kt-header-menu kt-header-menu-mobile "  >
					...
					<?php if(read_access('Dashboards')):?>
						<li class="kt-menu__item  kt-menu__item--submenu kt-menu__item--rel"  data-ktmenu-submenu-toggle="click" aria-haspopup="true">
							...
							<div class="kt-menu__submenu kt-menu__submenu--classic kt-menu__submenu--left">
								...
								<?php if($this->session->userdata('user')->level == 'administrator' || $this->session->userdata('user')->level == 'area' || $this->session->userdata('user')->level == 'pusat' || $this->session->userdata('user')->level == 'cabang' || $this->session->userdata('user')->level == 'Admin Gadai Elektronik'):?>
									<?php if(read_access('dashboards')):?>
								...
								<?php endif;?>
									...
									<?php if($this->session->userdata('user')->level == 'pusat' || $this->session->userdata('user')->level == 'area' || $this->session->userdata('user')->level == 'Admin Gadai Elektronik'):?>
									<?php if(read_access('dashboards')):?>
										<!--<li class="kt-menu__item "  aria-haspopup="true">-->
										<!--	<a  href="<?php echo base_url('dashboards'); ?>" class="kt-menu__link ">-->
										<!--		<span class="kt-menu__link-icon"><i class="fa fa-chart-bar"><span></span></i></span>-->
                                ...
                                <?php if($this->session->userdata('user')->level == 'pusat' || $this->session->userdata('user')->level == 'administrator' || $this->session->userdata('user')->level == 'Admin Gadai Elektronik'):?>
                                    <?php if(read_access('dashboards/pengeluaran')):?>
                                    <li class="kt-menu__item " aria-haspopup="true">
                                        <a href="<?php echo base_url('kpi/Kpii'); ?>" class="kt-menu__link ">
                                            <span class="kt-menu__link-icon"><i
                                                    class="fa fa-chart-bar"><span></span></i></span>
                                            <span class="kt-menu__link-text">KPI</span>
                                        </a>
                                    </li>
                                    <?php endif;?>
                                <?php endif;?>
							...
							<div class="kt-menu__submenu kt-menu__submenu--classic kt-menu__submenu--left">
								...
								<li class="kt-menu__item  kt-menu__item--submenu"  data-ktmenu-submenu-toggle="hover" aria-haspopup="true">
									...
									<i class="fa fa-copy"><span></span></i>
											...
											<span class="kt-menu__link-text">KPI</span><i class="kt-menu__hor-arrow la la-angle-right"></i><i class="kt-menu__ver-arrow la la-angle-right"></i>
										</a>
										<div class="kt-menu__submenu kt-menu__submenu--classic kt-menu__submenu--right">
											<ul class="kt-menu__subnav">
											
												
												<?php if(read_access('datamaster/bobot')):?>
													<li class="kt-menu__item "  aria-haspopup="true">
														<a  href="<?php echo base_url('datamaster/bobot'); ?>" class="kt-menu__link ">
															<i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i>
															<span class="kt-menu__link-text">Bobot KPI</span>
														</a>
													</li>
												<?php endif;?>
												
												<?php if(read_access('datamaster/ProfitUnit')):?>
													<li class="kt-menu__item "  aria-haspopup="true">
														<a  href="<?php echo base_url('datamaster/ProfitUnit'); ?>" class="kt-menu__link ">
															<i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i>
															<span class="kt-menu__link-text">Profit KPI</span>
														</a>
													</li>
												<?php endif;?>
						...
						<li class="kt-menu__item  kt-menu__item--submenu kt-menu__item--rel"  data-ktmenu-submenu-toggle="click" aria-haspopup="true">
							...
							<div class="kt-menu__submenu kt-menu__submenu--classic kt-menu__submenu--left">
								...
								<?php if(read_access('transactions/customers')):?>
									...
									<li class="kt-menu__item " aria-haspopup="true">
										<a href="<?php echo base_url('transactions/RepaymentCorrection'); ?>"
												class="kt-menu__link ">
												<span class="kt-menu__link-icon"><i class="fa fa-file"><span></span></i></span>
												<span class="kt-menu__link-text">Koreksi Pelunasan
										</a>
								</li>
								</ul>
							</div>
						...
						<li class="kt-menu__item  kt-menu__item--submenu kt-menu__item--rel"  data-ktmenu-submenu-toggle="click" aria-haspopup="true">
							...
							<div class="kt-menu__submenu kt-menu__submenu--classic kt-menu__submenu--left">
								<ul class="kt-menu__subnav">
									...
									<!--	<li class="kt-menu__item "  aria-haspopup="true">-->
									<!--		<a  href="<?php echo base_url('report/smartphone'); ?>" class="kt-menu__link ">-->
									<!--			<span class="kt-menu__link-icon"><i class="fa fa-file"><span></span></i></span>-->
             ...
             <!--                       <?php endif;?>-->
												...
												<?php if(read_access('report/bukubank')):?>
													<li class="kt-menu__item "  aria-haspopup="true">
														<a  href="<?php echo base_url('report/transactions'); ?>" class="kt-menu__link ">
															<i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i>
															<span class="kt-menu__link-text">Transaksi</span>
														</a>
													</li>
												...
												<?php if(read_access('report/bukubank')):?>
													<li class="kt-menu__item "  aria-haspopup="true">
														<a  href="<?php echo base_url('report/transactions/outstanding'); ?>" class="kt-menu__link ">
															<i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i>
															<span class="kt-menu__link-text">Outstanding</span>
														</a>
													</li>
         ...
         <!--                                   <i class="fa fa-copy"><span></span></i>-->
         <!--                               </span>-->
         <!--                               <span class="kt-menu__link-text">Gcore</span><i-->
         <!--                                   class="kt-menu__hor-arrow la la-angle-right"></i><i-->
         <!--                                   class="kt-menu__ver-arrow la la-angle-right"></i>-->
         <!--                           </a>-->
         <!--                           <div class="kt-menu__submenu kt-menu__submenu--classic kt-menu__submenu--right">-->
         <!--                               <ul class="kt-menu__subnav">-->
         <!--                                   <?php if(read_access('report/gcore/outstanding')):?>-->
         <!--                                   <li class="kt-menu__item " aria-haspopup="true">-->
         <!--                                       <a href="<?php echo base_url('report/gcore/outstanding'); ?>"-->
         <!--                                           class="kt-menu__link ">-->
         <!--                                           <i-->
         <!--                                               class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i>-->
         <!--                                           <span class="kt-menu__link-text">Outstanding</span>-->
         ...
         <!--                                   <li class="kt-menu__item " aria-haspopup="true">-->
         <!--                                       <a href="<?php echo base_url('gcore/booking'); ?>"-->
         <!--                                           class="kt-menu__link ">-->
         <!--                                           <i-->
         <!--                                               class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i>-->
         <!--                                           <span class="kt-menu__link-text">Pencairan</span>-->
         ...
         <!--                                   <?php if(read_access('report/gcore/dpd')):?>-->
         <!--                                   <li class="kt-menu__item " aria-haspopup="true">-->
         <!--                                       <a href="<?php echo base_url('gcore/repayments'); ?>"-->
         <!--                                           class="kt-menu__link ">-->
         <!--                                           <i-->
         <!--                                               class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i>-->
         <!--                                           <span class="kt-menu__link-text">Pelunasan</span>-->
         ...
         <!--                       <?php endif;?>-->
									...
									<i class="fa fa-copy"><span></span></i>
										...
										<div class="kt-menu__submenu kt-menu__submenu--classic kt-menu__submenu--right">
											<ul class="kt-menu__subnav">
											    <?php if(read_access('report/yogadai/dashboard')):?>
													<li class="kt-menu__item "  aria-haspopup="true">
														<a  href="<?php echo base_url('report/yogadai/dashboard'); ?>" class="kt-menu__link ">
															<i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i>
															<span class="kt-menu__link-text">Dashboard</span>
														</a>
													</li>
									...
									<i class="fa fa-copy"><span></span></i>
											...
											<span class="kt-menu__link-text">TPPU/TPPT OJK</span><i class="kt-menu__hor-arrow la la-angle-right"></i><i class="kt-menu__ver-arrow la la-angle-right"></i>
										</a>
										<div class="kt-menu__submenu kt-menu__submenu--classic kt-menu__submenu--right">
											<ul class="kt-menu__subnav">			
				...
				<?php if(read_access('gcore')):?>
							...
							<div class="kt-menu__submenu kt-menu__submenu--classic kt-menu__submenu--left">
								<ul class="kt-menu__subnav">
									...
									<?php if ( $this->session->userdata( 'user' )->level == 'pusat' || $this->session->userdata( 'user' )->level == 'administrator' || $this->session->userdata('user')->level == 'Admin Gadai Elektronik' ){?>
                                        ...
                                        <div class="kt-menu__submenu kt-menu__submenu--classic kt-menu__submenu--right">
                                            <ul class="kt-menu__subnav">
                                                ...
                                                <?php if(read_access('gcore')):?>
                                                <li class="kt-menu__item " aria-haspopup="true">
                                                    <!-- <a href="<?php// echo base_url('gcore/kp/dpd'); ?>" -->
													<a href="<?php echo base_url('gcore/gcore/dpd'); ?>"
                                                        class="kt-menu__link ">
                                                        <span class="kt-menu__link-icon"><i
                                                                class="fa fa-file"><span></span></i></span>
                                                        <span class="kt-menu__link-text">DPD</span>
                                            ...
                                            <?php if(read_access('gcore')):?>
                                            <li class="kt-menu__item " aria-haspopup="true">
                                                <a href="<?php echo base_url('gcore/pelunasanCicilan'); ?>"
                                                    class="kt-menu__link ">
                                                    <span class="kt-menu__link-icon"><i
                                                            class="fa fa-file"><span></span></i></span>
                                                    <span class="kt-menu__link-text">Pelunasan Cicilan</span>
                                                </a>
                                            </li>
                                            <?php endif;?>
                                                <?php if(read_access('gcore')):?>
                                                ...
                                                <?php endif;?>
																								...
																								<li class="kt-menu__item " aria-haspopup="true">
                                                    <a href="<?php echo base_url('gcore/RepaymentCorrection'); ?>"
                                                        class="kt-menu__link ">
                                                        <span class="kt-menu__link-icon"><i
                                                                class="fa fa-file"><span></span></i></span>
                                                        <span class="kt-menu__link-text">Koreksi Pelunasan</span>
                                                    </a>
                                                </li>
                                                ...
                                                <?php if ($this->session->userdata( 'user' )->level == 'administrator'){?>
                                                 ...
                                                 <?php if(read_access('gcore')):?>
                                                <li class="kt-menu__item " aria-haspopup="true">
                                                    <a href="<?php echo base_url('gcore/konversi'); ?>"
                                                        class="kt-menu__link ">
                                                        <span class="kt-menu__link-icon"><i
                                                                class="fa fa-file"><span></span></i></span>
                                                        <span class="kt-menu__link-text">Konversi</span>
                                                    </a>
                                                </li>
                                            <?php endif;?>
                                            <?php };?>
																						<?php if(read_access('gcore')):?>
																						<li class="kt-menu__item "  aria-haspopup="true">
																							<a  href="<?php echo base_url('gcore/tppt'); ?>" class="kt-menu__link ">
																								<span class="kt-menu__link-icon"><i class="fa fa-file"><span></span></i></span>
																								<span class="kt-menu__link-text">TPPU/TPPT OJK</span>
																							</a>
																						</li>
																						<?php endif; ?>
									...
									<i class="fa fa-copy"><span></span></i>
											...
											<span class="kt-menu__link-text">Sales Agent</span><i class="kt-menu__hor-arrow la la-angle-right"></i><i class="kt-menu__ver-arrow la la-angle-right"></i>
										</a>
										<div class="kt-menu__submenu kt-menu__submenu--classic kt-menu__submenu--right">
											<ul class="kt-menu__subnav">
													<li class="kt-menu__item "  aria-haspopup="true">
														<a  href="<?php echo base_url('gcore/agentMaster'); ?>" class="kt-menu__link ">
															<i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i>
															<span class="kt-menu__link-text">Data Agent</span>
														</a>
													</li>
													<li class="kt-menu__item "  aria-haspopup="true">
														<a  href="<?php echo base_url('gcore/agent'); ?>" class="kt-menu__link ">
															<i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i>
															<span class="kt-menu__link-text">Transaksi</span>
														</a>
													</li>
									...
									<?php if(read_access('gcore')):?>
                                        <li class="kt-menu__item " aria-haspopup="true">
                                            <a  href="<?php echo base_url('gcore/booking'); ?>" class="kt-menu__link ">
    											<span class="kt-menu__link-icon"><i class="fa fa-file"><span></span></i></span>
    											<span class="kt-menu__link-text">Pencairan</span>
										    </a>
                                        </li>
                                        ...
                                        <?php if(read_access('gcore')):?>
                                        <li class="kt-menu__item " aria-haspopup="true">
                                             <a  href="<?php echo base_url('gcore/repayments'); ?>" class="kt-menu__link ">
    											<span class="kt-menu__link-icon"><i class="fa fa-file"><span></span></i></span>
    											<span class="kt-menu__link-text">Pelunasan</span>
										    </a>
                                        </li>
                                        ...
                                        <?php if(read_access('gcore')):?>
                                        <li class="kt-menu__item " aria-haspopup="true">
                                             <a  href="<?php echo base_url('gcore/approval'); ?>" class="kt-menu__link ">
    											<span class="kt-menu__link-icon"><i class="fa fa-file"><span></span></i></span>
                                        ...
                                        <?php if(read_access('gcore')):?>
                                        <li class="kt-menu__item " aria-haspopup="true">
                                             <a  href="<?php echo base_url('gcore/dpd'); ?>" class="kt-menu__link ">
    											<span class="kt-menu__link-icon"><i class="fa fa-file"><span></span></i></span>
    											<span class="kt-menu__link-text">DPD Cicilan</span>
										    </a>
                                        </li>
                                        <?php endif;?>
                                    ...
                                    <?php // if($this->session->userdata('user')->level=='administrator'){ ?>
                                      ...
                                      <?php  if($this->session->userdata('user')->username=='melchianus.heu' || $this->session->userdata('user')->level=='administrator'){ 
                                      ?>
									<!--<li class="kt-menu__item "  aria-haspopup="true">-->
									...
									<li class="kt-menu__item " aria-haspopup="true">
										<a href="<?php echo base_url('gcore/pagukas'); ?>" class="kt-menu__link ">
											<span class="kt-menu__link-icon">
												<i class="fa fa-file"><span></span></i></span>
											<span class="kt-menu__link-text">Pagu Kas</span>
										</a>
									</li>
					...
					<?php if($this->session->userdata('user')->level=='administrator' || $this->session->userdata('user')->level=='Admin Gadai Elektronik'):?>
					<li class="kt-menu__item  kt-menu__item--submenu kt-menu__item--rel"
                        data-ktmenu-submenu-toggle="click" aria-haspopup="true">
                        <a href="javascript:;" class="kt-menu__link kt-menu__toggle"><span
                                class="kt-menu__link-text">Elektronik</span><i
                                class="kt-menu__ver-arrow la la-angle-right"></i></a>
                        <div class="kt-menu__submenu kt-menu__submenu--classic kt-menu__submenu--left">
                            <ul class="kt-menu__subnav">
                                <li class="kt-menu__item " aria-haspopup="true">
                                    <a href="<?php echo base_url('gcore/hps'); ?>" class="kt-menu__link ">
                                        <span class="kt-menu__link-icon"><i class="fa fa-file"><span></span></i></span>
                                        <span class="kt-menu__link-text">HPS Konven</span>
                                    </a>
                                </li>
																<li class="kt-menu__item " aria-haspopup="true">
                                    <a href="<?php echo base_url('syariah/hps'); ?>" class="kt-menu__link ">
                                        <span class="kt-menu__link-icon"><i class="fa fa-file"><span></span></i></span>
                                        <span class="kt-menu__link-text">HPS Syariah</span>
                                    </a>
                                </li>
                            </ul>
                        </div>
