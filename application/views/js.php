    ...
    var dailySales = function() {
        ...
        var chartData = {
            ...
            datasets: [{
                ...
                data: [
                    15, 20, 25, 30, 25, 20, 15, 20, 25, 30, 25, 20, 15, 10, 15, 20, 15, 10, 15, 20,15, 20, 25, 30, 25, 20, 15, 20, 25, 30
                ]
            }, {
                //label: 'Dataset 2',
                backgroundColor: '#f3f3fb',
                data: [
                    110, 20, 25, 30, 25, 20, 15, 20, 25, 30, 25, 20, 15, 10, 15, 20
                ]
            }]
        };
...
function Dashboard(e) {
    ...
    var transaction = [];
    var total = 0;
    KTApp.block('#form_dashboard .kt-portlet', {});
    var today = 0;
    var yesterday = 0;
    var pelunasan = 0;
    var pendapatan = 0;
    ...
    $.ajax({
        url: "<?php echo base_url('api/report/order/get_dashboard');?>",
        type: "GET",
        dataType: "JSON",
        data: {
            // area: $('[name="area"]').val(),
            // date: datenow,
            // date_input: $('[name="date_input"]').val(),
        ...
        success: function(response) {
            ...
            $.each(response.data, function(index, data) {
                ...
                console.log(data.yes);
                    $('#form_dashboard').find('.order').text(data.yes + " pcs");
                    $('#form_dashboard').find('.sales').text(data.sales + " pcs");
                    $('#form_dashboard').find('.otw').text(data.otw + " pcs");
                    $('#form_dashboard').find('.stocks').text(data.stocks + " pcs");
        ...
        complete: function() {
            ...
            KTApp.unblock('#form_dashboard .kt-portlet', {});
        },
    });
}
...
//                     backgroundColor: KTApp.getStateColor('brand'),                    
//                     pointBackgroundColor: Chart.helpers.color('black').alpha(0).rgbString(),
