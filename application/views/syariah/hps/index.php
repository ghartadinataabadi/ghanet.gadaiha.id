            ...
            <div class='kt-container '>
                <div class='kt-subheader__main'>
                    <h3 class='kt-subheader__title'><a
                            href="<?php echo base_url('datamaster/customers');?>">HPS Syariah</a></h3>
                    <span class='kt-subheader__separator kt-subheader__separator--v'></span>
                    <span class='kt-subheader__desc'>HPS Syariah</span>
                </div>
            ...
            <div class='kt-portlet kt-portlet--mobile'>
                ...
                <div class='kt-portlet__body kt-portlet__body--fit'>
                    <div class='col-md-pull-12'>
                        ...
                        <!--end: Alerts -->
                        <!--begin: Search Form -->
                        <form action="<?php echo base_url('syariah/hps/excel');?>"
...
$this->load->view('syariah/hps/add.php');
$this->load->view('syariah/hps/edit.php');
$this->load->view('syariah/hps/js.php');
?>
